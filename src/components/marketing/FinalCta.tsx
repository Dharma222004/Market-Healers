  ...
  return (
    <section className="py-20 bg-[#0B1F3A] text-white relative overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2 w-full max-w-md sm:max-w-none mx-auto">
          <Link
            href="/onboarding"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 text-sm font-bold text-white bg-[#00A88F] hover:bg-[#008B76] rounded-xl shadow-md transition-all hover:scale-[1.02]"
          >
          ...
          <Link
            href="/#ai-ecosystem"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3.5 text-sm font-bold text-white bg-[#0E1A2B] hover:bg-[#15253C] border border-slate-700 rounded-xl transition-colors"
          >
