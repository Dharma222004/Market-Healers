...
export const FounderNote: React.FC = () => {
  return (
    <section id="founder-note" className="py-20 sm:py-28 bg-[#F6F8FA] border-b border-slate-200 relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Executive Presentation Card */}
        <div className="relative bg-white border border-slate-200/90 rounded-3xl p-6 sm:p-10 lg:p-14 shadow-xl overflow-hidden">
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center">
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="relative w-full max-w-sm sm:max-w-md aspect-[3/4] rounded-2xl overflow-hidden shadow-xl border border-slate-200 group bg-slate-100">
                <Image
                  src="/founder.jpg"
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-gradient-to-r from-[#08111F]/95 via-[#0E1A2B]/95 to-[#08111F]/95 backdrop-blur-xl border border-white/25 rounded-2xl px-5 py-3.5 flex items-center justify-between text-white shadow-2xl">
                  <div className="space-y-0.5">
                    <div className="text-base sm:text-lg font-extrabold tracking-tight text-white leading-tight">
                      Dharmadurai K
                    </div>
                    <div className="text-xs font-bold text-teal-300 font-mono tracking-wide uppercase">
                      Founder, Market Healers
                    </div>
                  </div>

                  <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-teal-500/20 border border-teal-400/50 text-teal-300 text-[11px] font-mono font-bold tracking-wider uppercase shadow-xs shrink-0">
            ...
            <div className="lg:col-span-7 flex flex-col justify-center space-y-6 text-left">
              ...
              <div className="border-l-2 border-[#00A88F] pl-5 sm:pl-6 py-1">
                <blockquote className="font-philosophy text-xl sm:text-2xl lg:text-[26px] font-medium text-[#0B1F3A] leading-relaxed tracking-tight text-balance">
